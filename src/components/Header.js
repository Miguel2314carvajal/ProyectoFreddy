...
function Header() {
  ...
  return (
    <>
      ...
      <nav className="sticky top-0 z-40 w-full flex items-center bg-white/80 dark:bg-[#23272F] backdrop-blur-lg border-b border-transparent dark:border-transparent">
        <div className="flex items-center justify-between w-full h-16">
          ...
          <div className="flex items-center gap-8 ml-32 pr-4">
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link to="/reference" className="text-[15px] font-medium text-slate-600 dark:text-slate-400 hover:text-sky-500 dark:hover:text-sky-400">Reference</Link>
